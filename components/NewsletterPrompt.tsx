...
export const NewsletterPrompt = () => {
    return (
        ...
        <div className='flex-1'>
          ...
          <p className='mt-1 text-sm leading-4 text-gray-300'>Sign up for our newsletter to stay up to date on this week's craziest news</p>
        </div>
        ...
        <div className='mt-2 w-full'>
          <form action="/api/newsletter/add" method='POST'>
            ...
            <div className='mt-3 rounded-md shadow'>
              <button className="flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white focus:outline-none transition duration-150 ease-in-out w-full" type="submit">Subscribe</button>
            </div>
          </form>
